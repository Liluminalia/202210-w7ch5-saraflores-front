...
import { FavoriteRobotsList } from './favorite.robots.list';

describe('Given FavoriteRobotsList component', () => {
    describe('When we render the component', () => {
        test('Then it should display favorite Robots List', () => {
            ...
            render(
                <Router>
                    <Provider store={appStore}>
                        <FavoriteRobotsList item={mockList} />
                    </Provider>
                </Router>
            );
